module Vagrant
    module ElastiSearchCluster
        class Util
            ...
            def get_filebeat_config_template
                conf_dir = get_conf_dir()
                config_file = File.open("#{conf_dir}/filebeat.yml.erb", 'r')
                ERB.new(config_file.read)
            end
            ...
            def build_filebeat_config(name)
                conf_dir = get_conf_dir()
                conf_file_format = "#{conf_dir}/filebeat-#{name}.yml"
